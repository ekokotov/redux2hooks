...
const devBuild = () => ({
  ...
  plugins: [
    ...
    commonjs({
      ...
      namedExports: {
        'node_modules/react/index.js': ['Children', 'Component', 'PropTypes', 'createElement', 'useLayoutEffect', 'useEffect', 'useMemo', 'useRef', 'useContext', 'useReducer', 'Fragment', 'createContext'],
